var passwords = ['HACKCAILON', 'EOPIDANGYEU', 'HACKERNHUCAC', 'THANGSUCVAT', 'DITMEMAY', 'LOLITEAM', 'DIIAHOTAO', 'ILOVEYOUEOPI', 'THANGNGU', 'OCCHOVL', 'TINNGUOIVL'];
var indexOld;
...
$('.rerun').on('click', function() {
	//cái khúc này là đéo cho phép hiển thị cùng một mật khẩu hai lần liên tiếp để bọn mày ăn chửi sml đmm nhé xem source con cặc
	indexOld = index; 
	do {
